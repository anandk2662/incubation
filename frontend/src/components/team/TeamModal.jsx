        ...
        <div className="flex flex-col items-center text-center md:border-r border-border-primary md:pr-8 pb-6 md:pb-0 border-b md:border-b-0">
          ...
          <div className="flex gap-6 mb-8">
            <div className="flex flex-col">
              <span className="text-lg font-black text-text-primary">{member.currentProject || 'N/A'}</span>
              <span className="text-[10px] text-text-tertiary uppercase tracking-widest">Current Project</span>
            </div>
          </div>
