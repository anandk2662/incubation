...
export default function Badge({ children, variant = 'default', size = 'sm', dot = false }) {
  ...
  const variants = {
    ...
    active: 'bg-primary-blue/10 text-primary-blue border-primary-blue/20',
    beta: 'bg-[#FFD54F]/10 text-[#FFD54F] border-[#FFD54F]/20',
    research: 'bg-[#B388FF]/10 text-[#B388FF] border-[#B388FF]/20',
    soon: 'bg-bg-elevated text-text-tertiary border-border-primary'
  };
