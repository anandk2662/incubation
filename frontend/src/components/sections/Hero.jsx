      ...
      */}
      <div className="lg:hidden absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute inset-0 blur-[100px] opacity-20">
          <div className="absolute w-[250px] h-[250px] top-[-5%] left-[-10%] rounded-full bg-text-primary animate-pulse" />
          <div className="absolute w-[200px] h-[200px] bottom-[5%] right-[-10%] rounded-full bg-text-primary animate-pulse [animation-delay:2s]" />
        </div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[400px] aspect-square opacity-10 text-text-primary">
          <HeroSVG />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] items-center gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              <h1 className="text-[clamp(40px,9vw,80px)] font-black leading-[0.9] tracking-tighter mb-4 text-text-primary" id="hero-title">
                Building the <span className="bg-gradient-to-br from-text-primary to-text-disabled bg-clip-text text-transparent">future</span> of technology.
              </h1>
          ...
          <div className="hidden lg:flex relative justify-center items-center">
            <div className="absolute inset-0 blur-[80px] opacity-30 pointer-events-none">
              <div className="absolute w-[280px] h-[280px] top-[-5%] left-0 rounded-full bg-text-primary animate-pulse" />
              <div className="absolute w-[220px] h-[220px] bottom-0 right-[-5%] rounded-full bg-text-primary animate-pulse [animation-delay:2s]" />
            </div>
            <div className="relative w-full max-w-[380px] aspect-square z-10 text-text-primary">
              <HeroSVG />
            </div>
          </div>
...
function HeroSVG() {
  return (
    <svg viewBox="0 0 400 400" className="w-full h-full">
      ...
      <motion.circle
        cx="200" cy="200" r="120"
        stroke="currentColor" strokeWidth="0.75" fill="none" strokeDasharray="4 4"
        initial={{ rotate: 0, opacity: 0 }}
