            ...
            >
              <div className="relative mb-5 sm:mb-6">
                <div className={`w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center border-2 transition-all duration-500 z-10 shrink-0 ${
                  stage.status === 'completed' ? 'text-text-primary border-border-primary bg-bg-elevated' :
                  stage.status === 'active' ? 'text-white border-primary-blue bg-primary-blue shadow-[0_8px_32px_rgba(255,255,255,0.4)] scale-105' :
