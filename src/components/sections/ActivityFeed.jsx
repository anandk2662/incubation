  ...
  return (
    <div className="max-w-[800px] mx-auto" id="activity">
      <div className="text-center mb-12 sm:mb-16">
        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-tertiary mb-3 block">Timeline</span>
        <h2 className="text-2xl sm:text-5xl font-black tracking-tight mb-4 text-text-primary">Latest Updates</h2>
      ...
      <div className="flex flex-col">
        {activity.map((item, index) => {
          ...
          return (
            <motion.div 
              key={item.id} 
              className="flex gap-4 sm:gap-8 pb-8 sm:pb-12"
            ...
            >
              ...
              <div className="pt-1">
                <div className="flex flex-wrap items-baseline gap-1.5 text-sm sm:text-base leading-snug mb-2">
