...
export default function TeamCard({ member, onClick }) {
  return (
    <div className="w-[280px] shrink-0 bg-bg-surface border border-border-primary rounded-md p-6 relative overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:border-border-hover select-none group" onClick={() => onClick(member)}>
      <div className="mb-4">
      ...
      <div className="mb-2">
        ...
        <p className="text-sm text-text-tertiary font-medium mb-4">{member.role}</p>
      ...
      <div className="absolute inset-0 bg-bg-primary/90 backdrop-blur-md flex flex-col justify-center items-center p-6 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
