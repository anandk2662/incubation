    ...
    <div className="pt-32 sm:pt-28 min-h-screen">
      <div className="container">
        <header className="mb-8 sm:mb-12">
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-3 text-text-primary">The Team</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-12 sm:pb-16">
          {team.map(member => (
